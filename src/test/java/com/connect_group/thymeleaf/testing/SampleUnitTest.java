...
public class SampleUnitTest {
  ...
  public static final String HTML_PATH_IN_TEST_RESOURCES_FOLDER = ThymesheetTestSpringContext
      .getTestResourcesHtmlPath("/sampleUnitTest.html");
  ...
  public void shouldCreateThreeParagraphsUnderHeading1WithExpectedContent() throws Exception {
    model.put("section1Paragraphs", Arrays.asList("para 1", "para 2", "para 3"));
    HtmlElements tags = testEngine.process(HTML_PATH_IN_TEST_RESOURCES_FOLDER, model);
    assertThat(tags.matching("body > p:nth-of-type(-n+3)"),
        hasOnlyText("para 1", "para 2", "para 3"));
  }
  ...
  public void shouldCreateFourParagraphsUnderHeading2WithExpectedContent() throws Exception {
    ...
    HtmlElements tags = testEngine.process(HTML_PATH_IN_TEST_RESOURCES_FOLDER, model);
    assertThat(tags.matching("body > h2~p"),
        hasOnlyText("para b1", "para b2", "para b3", "para b4"));
  }
  ...
  public void shouldSpecifyExpectedUrlInLink() throws Exception {
    ...
    HtmlElements tags = testEngine.process(HTML_PATH_IN_TEST_RESOURCES_FOLDER, model);
    assertThat(tags.matching("body > a"),
        isSingleElementThat(hasAttribute("href", "http://expected/target/url")));
  }

  @Test
  public void shouldUseTextFromResourceBundle_WhenPreTagRefersToMessageSourceKey()
      throws Exception {
